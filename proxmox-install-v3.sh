...
#
# Usage:
#   ./proxmox-install-v3.sh                    # Interactive mode (recommended)
#   ./proxmox-install-v3.sh --interactive     # Force interactive mode
#   curl -fsSL https://raw.githubusercontent.com/crowninternet/solarassistant/master/proxmox-install-v3.sh | bash
#
# ═══════════════════════════════════════════════════════════════════════════
...
if [[ "$1" == "--help" ]] || [[ "$1" == "-h" ]]; then
    ...
    echo "  curl -fsSL https://raw.githubusercontent.com/crowninternet/solarassistant/master/proxmox-install-v3.sh | bash"
    echo ""
...
main() {
    ...
    if [[ "$1" == "--interactive" ]] || [[ "$1" == "-i" ]] || [[ -t 0 ]]; then
        ...
        echo "  wget https://raw.githubusercontent.com/crowninternet/solarassistant/master/proxmox-install-v3.sh"
        echo "  chmod +x proxmox-install-v3.sh"
        echo "  ./proxmox-install-v3.sh"
